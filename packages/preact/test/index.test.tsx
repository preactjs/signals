...
describe("@preact/signals", () => {
	...
	describe("SignalValue bindings", () => {
		...
		it("JSX in SignalValue should be reactive", async () => {
			...
			expect(scratch.firstChild!.firstChild!.textContent!).toEqual("a");
		});
		...
		const maybeRun = typeof gc === "undefined" ? describe.skip : describe;

		maybeRun("garbage collection", function () {
